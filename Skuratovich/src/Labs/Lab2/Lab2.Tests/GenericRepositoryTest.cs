...
namespace Lab2.Tests
{
    ...
    public class GenericRepositoryTest
    {
        ...
        {
            // Arrange
            var fileHandlerMock = new Mock<IGenericFileHandler<Book>>();

            // Act
            var subject = new GenericRepository<Book>(fileHandlerMock.Object);
        ...
        [TestMethod]
        public void Add_AddBook_Contains()
        {
            // Arrange
            var fileHandlerMock = new Mock<IGenericFileHandler<Book>>();
