...
namespace Htp.ITnews.Web.Pages.News
{
    ...
    public class EditModel : PageModel
    {
        ...
        //public async Task<IActionResult> OnGetNewsTags(Guid id, string term)
        //{
        //    var newsTags = await newsService.GetTagsAsync(NewsViewModel.Id);
        //    return new JsonResult(newsTags);
        //}
